...
•	Documented R Markdown Output – this includes providing internal documentation (within the r code).  Don’t forget to include the r code as well the output from the r code (set echo to true). 
•	Rmd file
•	Github repository with your project posted
